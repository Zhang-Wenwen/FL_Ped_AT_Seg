...
class LearnerExecutor(Executor):
    ...
    def train(self, shareable: Shareable, fl_ctx: FLContext, abort_signal: Signal) -> Shareable:
        ...
        # print("nvflare validate before training:",from_shareable(validate_result).data)

        train_result, validate_result = self.learner.train(shareable, fl_ctx, abort_signal)
